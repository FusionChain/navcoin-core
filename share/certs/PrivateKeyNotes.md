...
unlocked to sign the SoftCoin-Qt.app bundle.
...
allowing somebody to distribute a SoftCoin-Qt.app or softcoin-qt-setup.exe with a valid
...
that the softcoin-qt.exe file inside the installer had not been tampered with.
