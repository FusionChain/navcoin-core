...
class RawTransactionsTest(SoftCoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid softcoin address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid softcoin address" in e.error['message'])
