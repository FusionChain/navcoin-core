...
#ifndef SOFTCOIN_TEST_SCRIPTNUM10_H
#define SOFTCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from SoftCoin Core 0.10.0, for cross-comparison.
 */
public:
