...
#define BOOST_TEST_MODULE SoftCoin Test Suite

#include "test_softcoin.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_softcoin_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
