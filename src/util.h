 ...
 */
#ifndef SOFTCOIN_UTIL_H
#define SOFTCOIN_UTIL_H
...
extern const char * const SOFTCOIN_CONF_FILENAME;
extern const char * const SOFTCOIN_PID_FILENAME;
...
{
    std::string s = strprintf("softcoin-%s", name);
