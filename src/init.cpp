...
// Copyright (c) 2017 The SoftCoin developers
 ...
 * between softcoind, and softcoin-qt and non-server tools.
*/
...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-conf=<file>", strprintf(_("Specify configuration file (default: %s)"), SOFTCOIN_CONF_FILENAME));
    if (mode == HMM_SOFTCOIND)
    {
#ifndef WIN32
...
#ifndef WIN32
    strUsage += HelpMessageOpt("-pid=<file>", strprintf(_("Specify pid file (default: %s)"), SOFTCOIN_PID_FILENAME));
#endif
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/softcoindev/softcoin-core>";
    const std::string URL_WEBSITE = "<https://softwarechain.org>";
...
/** Sanity checks
 *  Ensure that SoftCoin is running in a usable environment with all
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    // Make sure only a single SoftCoin process is using the data directory.
    ...
    if(GetBoolArg("-staking", true))
        threadGroup.create_thread(boost::bind(&SoftCoinStaker, boost::cref(chainparams)));
#endif
