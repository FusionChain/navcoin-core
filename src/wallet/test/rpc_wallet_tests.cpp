...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CSoftCoinAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CSoftCoinAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey();
        demoAddress = CSoftCoinAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CSoftCoinAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CSoftCoinAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CSoftCoinAddress(arr[0].get_str()).Get() == demoAddress.Get());
