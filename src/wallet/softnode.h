...
#ifndef SOFTCOIN_WALLET_SOFTNODE_H
#define SOFTCOIN_WALLET_SOFTNODE_H
...
#define SOFTNODE_DEFAULT_INPUT_DELAY 1
#define SOFTNODE_DEFAULT_OUT_DELAY 10
#define SOFTNODE_DEFAULT_ENTROPY 4
...
#endif //SOFTCOIN_WALLET_SOFTNODE_H
