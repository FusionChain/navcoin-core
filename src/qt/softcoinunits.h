...
#ifndef SOFTCOIN_QT_SOFTCOINUNITS_H
#define SOFTCOIN_QT_SOFTCOINUNITS_H
...
/** SoftCoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class SoftCoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit SoftCoinUnits(QObject *parent);

    /** SoftCoin units.
      @note Source: https://en.softcoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        SOFT,
...
typedef SoftCoinUnits::Unit SoftCoinUnit;

#endif // SOFTCOIN_QT_SOFTCOINUNITS_H
