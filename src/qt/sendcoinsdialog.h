...
#ifndef SOFTCOIN_QT_SENDCOINSDIALOG_H
#define SOFTCOIN_QT_SENDCOINSDIALOG_H
...
public Q_SLOTS:
    ...
    void checkSoftnodeServers();
    void showSoftNodeDialog();
...
#endif // SOFTCOIN_QT_SENDCOINSDIALOG_H
