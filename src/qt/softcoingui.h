...
#ifndef SOFTCOIN_QT_SOFTCOINGUI_H
#define SOFTCOIN_QT_SOFTCOINGUI_H
...
/**
  SoftCoin GUI main class. This class represents the main window of the SoftCoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class SoftCoinGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit SoftCoinGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~SoftCoinGUI();
...
#endif // SOFTCOIN_QT_SOFTCOINGUI_H
