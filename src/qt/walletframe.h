...
#ifndef SOFTCOIN_QT_WALLETFRAME_H
#define SOFTCOIN_QT_WALLETFRAME_H
...
public:
    explicit WalletFrame(const PlatformStyle *platformStyle, SoftCoinGUI *_gui = 0);
    ~WalletFrame();
...
#endif // SOFTCOIN_QT_WALLETFRAME_H
