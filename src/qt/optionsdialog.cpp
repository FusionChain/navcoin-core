    ...
    mapper(0)
{
    ...
    ui->softcoinAtStartup->setToolTip(ui->softcoinAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->softcoinAtStartup->setText(ui->softcoinAtStartup->text().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new SoftCoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->softcoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openSoftCoinConfButton_clicked()
{
