...
public:
    ...
    {
        getAddressToReceive->setWindowTitle(QApplication::translate("getAddressToReceive", "Form", 0));
        label->setText(QApplication::translate("getAddressToReceive", "Use the following address to receive SoftCoins:", 0));
#ifndef QT_NO_TOOLTIP
        lblQRCode->setToolTip(QApplication::translate("getAddressToReceive", "QR Code", 0));
#endif // QT_NO_TOOLTIP
        copyClipboardButton->setText(QApplication::translate("getAddressToReceive", "Copy to clipboard", 0));
        newAddressButton->setText(QApplication::translate("getAddressToReceive", "Generate a new address", 0));
        requestPaymentButton->setText(QApplication::translate("getAddressToReceive", "Request payment", 0));
        requestNewAddressButton->setText(QApplication::translate("getAddressToReceive", "List old addresses", 0));
    } // retranslateUi
