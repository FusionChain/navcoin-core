...
This document provides guidelines for internationalization of the SoftCoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `softcoin_en.ts` remains unchanged.
